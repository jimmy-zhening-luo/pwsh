...
)
{
  ...
  [Parameter]
  public long ReadCount { private get; set; }

  [Parameter]
  [Alias("First", "Head")]
  [ValidateRange(ValidateRangeKind.NonNegative)]
  public long TotalCount { private get; set; }

  [Parameter]
  [Alias("Last")]
  [ValidateRange(ValidateRangeKind.NonNegative)]
  public int Tail { private get; set; }

  [Parameter]
  required public string Delimiter { private get; set; }
  ...
  [Parameter]
  public SwitchParameter AsByteStream { private get; set; }

  [Parameter]
  public SwitchParameter Raw { private get; set; }

  [Parameter]
  public SwitchParameter Wait { private get; set; }
